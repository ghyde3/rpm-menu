...
// Ported faithfully from RPM Pub Design System/components/core/Button.jsx
// (+ Button.d.ts contract). Chunky, flat, hard-edged bar-signage button.
...
export function Button({
  ...
  const base: React.CSSProperties = {
    ...
    transition:
      "transform var(--dur-fast) var(--ease), background var(--dur) var(--ease), border-color var(--dur) var(--ease)",
    whiteSpace: "nowrap",
    ...sizes[size],
  };
  ...
  const hoverStyle: React.CSSProperties | null =
    !disabled && hover
      ? ({
        ...
        } as Record<ButtonVariant, React.CSSProperties>)[variant]
      : null;
