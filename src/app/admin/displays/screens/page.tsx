  ...
  return (
    <div>
      ...
      >
        ...
        {isOwner && (
          <Link href="/admin/displays/screens/new">
      ...
      <div style={{ marginTop: "var(--sp-5)", display: "flex", flexDirection: "column", gap: "var(--sp-3)" }}>
          ...
          <Card>
            <p style={{ color: "var(--text-faint)", fontFamily: "var(--font-body)", margin: 0 }}>
              {isOwner ? (
                <>
                  No screens yet.{" "}
                  <Link href="/admin/displays/screens/new" style={{ color: "var(--accent-primary)" }}>
        ...
        {sorted.map((screen) => (
          <Link key={screen.id} href={`/admin/displays/screens/${screen.id}`} style={{ textDecoration: "none" }}>
            <Card
              style={{
                display: "flex",
                alignItems: "center",
