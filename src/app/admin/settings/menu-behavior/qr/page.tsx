// Settings > Menu Behavior > QR Code Generator (§3.8/§9 M3): print-ready
// SVG + PNG QR pointing at the public menu -- table tents, no third-party
// QR service with tracking redirects. Owned by the
// settings-api-keys-data-recovery-sessions-qr unit; the parent Menu
// Behavior tab (owned by the settings-branding-menu-behavior unit) links
// here.
...
function OwnerOnlyNotice() {
  return (
    <div>
      <h1 style={pageTitleStyle()}>Settings · Menu Behavior · QR Code</h1>
  ...
  return (
    <div>
      ...
      <p style={{ fontFamily: "var(--font-body)", color: "var(--text-muted)", fontSize: "0.875rem" }}>
        <Link href="/admin/settings/menu-behavior" style={{ color: "var(--accent-primary)" }}>
